...
import { MessageSquare, Image, Save, ExternalLink } from "lucide-react";
                ...
                <div className="flex gap-2">
                  <Textarea
                    ...
                    onChange={(e) =>
                      setComplaints((prev) =>
                        prev.map((c) =>
                          c.id === complaint.id ? { ...c, internal_notes: e.target.value } : c
                        )
                      )
                    }
                    rows={2}
                  ...
                  <Button
                    ...
                    size="sm"
                    className="self-end"
                    onClick={() => updateComplaint(complaint.id, { internal_notes: complaint.internal_notes })}
                  >
